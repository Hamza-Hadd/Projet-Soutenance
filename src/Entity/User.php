...
class User implements /*Serializable,*/ UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @Vich\UploadableField(mapping="artworks", fileNameProperty="imageCoverName")
     *
     * @var File|null
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=Artwork::class, mappedBy="user_id")
     */
    private $artworks;
     ...
     * during Doctrine hydration.
     *
     * @param File|UploadedFile|null $imageCoverFile
     */
    public function setImageCoverFile(?File $imageCoverFile = null): void
    {
        $this->imageCoverFile = $imageCoverFile;

        if (null !== $imageCoverFile instanceof UploadedFile) {
            // It is required that at least one field changes if you are using doctrine
            // otherwise the event listeners won't be called and the file is lost
            $this->publishAt = new \DateTimeImmutable('now');
        }
    }
    ...
    public function removeArtwork(Artwork $artwork): self
    {
        if ($this->artworks->removeElement($artwork)) {
            ...
            if ($artwork->getUserId() === $this) {
                $artwork->setUserId(null);
            }
        }
